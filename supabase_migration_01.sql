...
-- Simple RLS Policies (use IF NOT EXISTS to avoid errors if already exists)
CREATE POLICY IF NOT EXISTS "branches_select" ON branches FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "departments_select" ON departments FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "cost_centers_select" ON cost_centers FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "user_profiles_select" ON user_profiles FOR SELECT USING (auth.uid() IS NOT NULL);
CREATE POLICY IF NOT EXISTS "products_select" ON products FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "product_categories_select" ON product_categories FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "product_brands_select" ON product_brands FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "warehouses_select" ON warehouses FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "customers_select" ON customers FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "sales_select" ON sales FOR SELECT USING (true);
